...
start_numbers = list(str(x) for x in range(10))
...
class CardinalDirsClockwiseNoAbbrevTask:
    def __init__(self, device, model_name="llama", n_devices=None):
        self.device = device
        ...
        self.prefix = f"{BASE_DIR}{model_name}_addition/"
    ...
    def important_tokens(self):
        important_tokens = [9, 13, 26, 27]
        # OR SHOULD IT BE
        # important_tokens = list(range(9, 27 + 1))
        # I believe this is never called
